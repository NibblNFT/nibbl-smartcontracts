...
import { INibblVaultUpgraded } from "./INibblVaultUpgraded.sol";
...
contract UpgradedNibblVault is INibblVaultUpgraded, BancorFormula, ERC20Upgradeable, Twav {

    bytes32 _storageFill;
    ...
    uint32 private constant primaryReserveRatio = 300_000;
